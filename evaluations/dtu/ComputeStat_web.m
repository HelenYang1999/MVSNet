...
dataPath='G:\dataset\mvsnet\dtu\';
resultsPath='D:\Python Programs\MVSNet_pytorch\models\outputs\';
...
for cStat=1:length(UsedSets) %Data set number
    ...
    %input results name  D:\Python Programs\MVSNet_pytorch\models\outputs\mvsnet_Eval_1.mat
